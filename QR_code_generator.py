...
#fucntio to store data in csv files
def storedata():
...
#functio to save barcode in png format
def brsave():
    try:
...
#function to clear out any entry boxes when the user shifts focus 
...
#function to repopulate the default text previously inside the entry boxes if nothing is putin
